...
class PaletteGenerator with Diagnosticable {
  ...
  static Future<PaletteGenerator> fromImageProvider(
    ...
    print('entering fromImageProvider');
    ...
    listener = ImageStreamListener((ImageInfo info, bool synchronousCall) {
      print('in image stream listener');
      loadFailureTimeout?.cancel();
      stream.removeListener(listener);
      print('completing imageCompleter');
    ...
    print('adding stream listener');
    stream.addListener(listener);
    print('added stream listener');

    print('waiting for imageCompleter');
    final ui.Image image = await imageCompleter.future;
    print('imageCompleter completed');
...
class _ColorCutQuantizer {
  ...
  List<PaletteColor> _quantizeColors() {
    print('starting _quantizeColors');
